...
EKTVL53L1X::EKTVL53L1X(TwoWire &i2cPort, int shutdownPin, int interruptPin)
{
	_i2cPort = &i2cPort;
...
bool EKTVL53L1X::init()
{
	return _device->VL53L1X_SensorInit();
}

bool EKTVL53L1X::begin()
{
	if (checkID() == false)
...
VL53L1X_Version_t EKTVL53L1X::getSoftwareVersion()
{
...
void EKTVL53L1X::setI2CAddress(uint8_t addr)
{
	_i2cAddress = addr;
	_device->VL53L1X_SetI2CAddress(addr);
}

int EKTVL53L1X::getI2CAddress()
{
	return _i2cAddress;
}

void EKTVL53L1X::clearInterrupt()
{
	_device->VL53L1X_ClearInterrupt();
}

void EKTVL53L1X::setInterruptPolarityHigh()
{
	_device->VL53L1X_SetInterruptPolarity(1);
}

void EKTVL53L1X::setInterruptPolarityLow()
{
...
uint8_t EKTVL53L1X::getInterruptPolarity()
{
	uint8_t tmp;
...
void EKTVL53L1X::startRanging()
{
	_device->VL53L1X_StartRanging();
}

void EKTVL53L1X::stopRanging()
{
	_device->VL53L1X_StopRanging();
}

bool EKTVL53L1X::checkForDataReady()
{
	uint8_t dataReady;
...
void EKTVL53L1X::setTimingBudgetInMs(uint16_t timingBudget)
{
	_device->VL53L1X_SetTimingBudgetInMs(timingBudget);
}

uint16_t EKTVL53L1X::getTimingBudgetInMs()
{
...
void EKTVL53L1X::setDistanceModeLong()
{
	_device->VL53L1X_SetDistanceMode(2);
}

void EKTVL53L1X::setDistanceModeShort()
{
	_device->VL53L1X_SetDistanceMode(1);
}

uint8_t EKTVL53L1X::getDistanceMode()
{
...
void EKTVL53L1X::setIntermeasurementPeriod(uint16_t intermeasurement)
{
	_device->VL53L1X_SetInterMeasurementInMs(intermeasurement);
}

uint16_t EKTVL53L1X::getIntermeasurementPeriod()
{
...
bool EKTVL53L1X::checkBootState()
{
	uint8_t bootState;
...
uint16_t EKTVL53L1X::getSensorID()
{
	uint16_t id;
...
uint16_t EKTVL53L1X::getDistance()
{
	uint16_t distance;
...
uint16_t EKTVL53L1X::getSignalPerSpad()
{
	uint16_t temp;
...
uint16_t EKTVL53L1X::getAmbientPerSpad()
{
	uint16_t temp;
...
uint16_t EKTVL53L1X::getSignalRate()
{
	uint16_t temp;
...
uint16_t EKTVL53L1X::getAmbientRate()
{
	uint16_t temp;
...
uint8_t EKTVL53L1X::getRangeStatus()
{
	uint8_t temp;
...
void EKTVL53L1X::setOffset(int16_t offset)
{
	_device->VL53L1X_SetOffset(offset);
}

int16_t EKTVL53L1X::getOffset()
{
	int16_t temp;
...
void EKTVL53L1X::setXTalk(uint16_t xTalk)
{
	_device->VL53L1X_SetXtalk(xTalk);
}

uint16_t EKTVL53L1X::getXTalk()
{
	uint16_t temp;
...
void EKTVL53L1X::setDistanceThreshold(uint16_t lowThresh, uint16_t hiThresh, uint8_t window)
{
	_device->VL53L1X_SetDistanceThreshold(lowThresh, hiThresh, window, 1);
}

uint16_t EKTVL53L1X::getDistanceThresholdWindow()
{
	uint16_t temp;
...
uint16_t EKTVL53L1X::getDistanceThresholdLow()
{
	uint16_t temp;
...
uint16_t EKTVL53L1X::getDistanceThresholdHigh()
{
	uint16_t temp;
...
void EKTVL53L1X::setROI(uint8_t x, uint8_t y, uint8_t opticalCenter)
{
	_device->VL53L1X_SetROI(x, y, opticalCenter);
}

uint16_t EKTVL53L1X::getROIX()
{
	uint16_t tempX;
	uint16_t tempY;
...
void EKTVL53L1X::setSignalThreshold(uint16_t signalThreshold)
{
	_device->VL53L1X_SetSignalThreshold(signalThreshold);
}

uint16_t EKTVL53L1X::getSignalThreshold()
{
	uint16_t temp;
...
void EKTVL53L1X::setSigmaThreshold(uint16_t sigmaThreshold)
{
	_device->VL53L1X_SetSigmaThreshold(sigmaThreshold);
}

uint16_t EKTVL53L1X::getSigmaThreshold()
{
	uint16_t temp;
...
void EKTVL53L1X::startTemperatureUpdate()
{
	_device->VL53L1X_StartTemperatureUpdate();
}

void EKTVL53L1X::calibrateOffset(uint16_t targetDistanceInMm)
{
	int16_t offset = getOffset();
	_device->VL53L1X_CalibrateOffset(targetDistanceInMm, &offset);
}

void EKTVL53L1X::calibrateXTalk(uint16_t targetDistanceInMm)
{
