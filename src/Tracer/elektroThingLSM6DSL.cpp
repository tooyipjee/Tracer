/******************************************************************************
elektroThing_LSM6DSL.cpp
Adapted for Tracer based on SparkfunLSM6DSL.cpp
...
//
//****************************************************************************//
LSM6DS3Core::LSM6DS3Core( uint8_t busType, uint8_t inputArg) : commInterface(I2C_MODE), I2CAddress(0x6B), chipSelectPin(0)
{
